...
const AddButton = ({id,data}) => {
    ...
    const handleClick = (event) => {
        ...
        return (
            ...
            <button
                onClick={handleClick}
                className={` bg-blue-medium text-black w-full hover:bg-purple hover:text-white rounded-3 mt-2 p-2 flex justify-center items-center z-[2] ${!data.quantity === 0 && 'cursor-not-allowed'}`}
                >
                {/* <svg
            ...
            <span className="text-[16px] font-semibold">Añadir al carrito</span>
                <svg
